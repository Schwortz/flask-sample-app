...
Generated at: 2026-01-11T13:17:46.809654+00:00
...
TEST_CASES = json.loads('''[
    {
        ...
        "category": "HAPPY_PATH",
        "endpoint": "/",
        "description": "Verify welcome endpoint returns correct message",
        "request_data": {
            "body": null,
            "path": {},
            "query": {}
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "endpoint": "/items",
        "description": "Verify getting items returns empty list initially",
        "request_data": {
            "body": null,
            "path": {},
            "query": {}
    ...
    {
        "name": "add_item_with_valid_json",
        "setup": null,
        "method": "POST",
        "cleanup": null,
        "category": "HAPPY_PATH",
        "endpoint": "/items",
        "description": "Add a new item with valid JSON payload",
        "request_data": {
            "body": {
                "name": "Test Product",
                "price": 29.99,
    ...
    {
        "name": "add_item_with_nested_structure",
        "setup": null,
        "method": "POST",
        "cleanup": null,
        "category": "HAPPY_PATH",
        "endpoint": "/items",
        "description": "Add item with complex nested JSON structure",
        "request_data": {
            "body": {
                "tags": [
                    "premium",
    ...
    },
    {
        ...
        "category": "NOT_FOUND",
        "endpoint": "/items/{item_id}",
        "description": "Attempt to get non-existent item by large index",
        "request_data": {
            "body": null,
            "path": {
                "item_id": 99999
